...
<tbody>
  <tr><td>Part of Brosephina Core modules</td><td><?=$module['isBrosephinaCore']?'Yes':'No'?></td></tr>
  <tr><td>Part of Brosephina CMF modules</td><td><?=$module['isBrosephinaCMF']?'Yes':'No'?></td></tr>
